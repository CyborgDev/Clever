  ...
  <div class="container-fluid">
    ...
    if ($lvl === 1){
        ...
        <ul class="nav navbar-nav navbar-right">
            <li><a href="index.php?page=member/register"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
            <li><a href="index.php?page=member/login"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
        </ul>';
    } elseif ($lvl === 2){
            echo '
                <ul class="nav navbar-nav navbar-right">
